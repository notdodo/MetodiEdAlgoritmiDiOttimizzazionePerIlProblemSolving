...
\begin{flalign}
	& L(u)=Min\;\displaystyle\sum_{i=1}^{m}\sum_{j=1}^{n}c_{ij}x_{ij}-\overbrace{\sum_{j=1}^{n}u_{j}(\sum_{i=1}^{m}x_{ij}-1)}^{-u(Ax-b)} =\\
...
\begin{flalign}
	& L(u^{0})=\;\underset{x}{Min}\displaystyle\sum_{i=1}^{m}(\sum_{j=1}^{n}(c_{ij}-u_{j}^{0})x_{ij}+\sum_{j=1}^{n}u_{j}^{0}) \\
...
\begin{flalign}
	& u_{j}^{k}=u_{j}^{k-1}-2\cdot\frac{(+3 - (-9))}{\displaystyle\sum_{j=1}^{n}(\sum_{i=1}^{m}x_{ij}-1)^2}\cdot(\sum_{i=1}^{m}x_{ij}-1) \\
...
\begin{flalign}
& u_{j}^{k}=u_{j}^{k-1}-\alpha_{2}\cdot\frac{(z^{*} -L(u^{k-1}))}{\displaystyle\sum_{j=1}^{n}(\sum_{i=1}^{m}x_{ij}-1)^2}\cdot(\sum_{i=1}^{m}x_{ij}-1) \\
...
\begin{flalign}
& L(u)=Min\;\overbrace{\displaystyle\sum_{i=1}^{m}\sum_{j=1}^{n}c_{ij}x_{ij}-\sum_{i=1}^{m}\lambda_{i}(\sum_{j=1}^{n}a_{ij}x_{ij}-b_{i})}^{cx - \lambda(Ax-b)} =\\
